  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      onPointerDownOutside={(e) => {
        // The floating feedback button must stay usable even while a dialog
        // is open (see FeedbackWidget) - without this, Radix treats a click
        // on it as an "outside click" and closes the dialog first, so
        // there's nothing left on screen to pick an element from.
